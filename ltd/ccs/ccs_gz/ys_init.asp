...
<tr height="20" >
<td colspan=2 align="center"><font class="px12" color="blue">您目前进入的是预算初始化界面
</td>
</tr>
<form  method="post" action="ys_init1.asp" name="myform" >
<tr>
<td align="left"> 
...
<td align="left"> 
    <font class="px12" color="black">输入方式：
    <select name="fenpei" style="HEIGHT: 22px; WIDTH: 170px"> 
    <option selected value=2>手动分配</option>
    <option value=1>将年度总额平均分配到月</option>
    </select></font>
 </td>
</tr>
...
<tr>
 <td colspan=2 align="left"> 
    <font class="px12" color="black">预算指标：<INPUT  type="text"  name="edu" size=8>元</font>
 </td>
</tr>
<tr>
...
do while not rs.eof
str=str&trim(rs("depar"))&"/"&trim(rs("fkmcode"))&"/"&trim(rs("fkmshuom"))&"/"&trim(rs("kmshuom"))&"," 
rs.movenext
loop
Rs.Close
Set Rs = Nothing
...
function  changeclass2() {
 ...
 for  (i=0;i<a;i++)  {
   if  (ar[i][0]==lid) {
  document.myform.kemu.options.add(new Option(ar[i][2]+"("+ar[i][3]+")",ar[i][1])); 
   }
 }
}
</script>
