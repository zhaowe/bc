...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <form method="post" action="km_add1.asp" id="form1" name="form1">   
...
<tr height="25">
<td colspan=2 align="center"><font class="px12" color="blue">您目前进入的是添加预算科目界面
</td>
</tr>
<tr height="25" bgcolor="#E3E99E"  align="left">
<td colspan=2 align=center> <font class=px14 color=black>科目添加表单</font></td>
</tr>

<tr height="25" bgcolor="#E3E9EE"   align="left">
<td> <font class=px12>年份：<select name="nian" style="HEIGHT: 22px; WIDTH: 57px"> 
    <option selected><%=year(date)%></option>
    <option><%=(year(date)+1)%></option>
    </select></td>
</tr>
<tr height="25" bgcolor="#E3E9EE"    align="left">
<td> <font class=px12>部门：<select name="depar" style="HEIGHT: 22px; WIDTH: 100px"> 
    <%
...
<tr height="25" bgcolor="#E3E9EE"    align="left">
<td > <font class=px12>一、二级科目代码：<INPUT  type="text"  name=kmcode size=8></td>
</tr>

<tr height="25" bgcolor="#E3E9EE"    align="left">
<td > <font class=px12>一、二级科目说明：<INPUT type="text"  name=kmshuom size=30></td>
</tr>

<tr height="25" bgcolor="#E3E9EE"    align="left">
<td > <font class=px12>三、四级科目代码：<INPUT  type="text"  name=fkmcode size=8></td>
</tr>

<tr height="25" bgcolor="#E3E9EE"    align="left">
<td > <font class=px12>三、四级科目说明：<INPUT type="text"  name=fkmshuom size=30></td>
</tr>

<tr height="25" bgcolor="#E3E9EE" align="center"> <td align="middle"><input type="submit" value="提  交"  name="submit1"></td></tr>    
    </table>
    </form>
