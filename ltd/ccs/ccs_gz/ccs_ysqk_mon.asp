...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <% objrst.Source = "select * from shenzhencwys  where  dep='"& session("dep") &"' and kem='" & km &"' and bztime='"& today &"'  order by fkem,bztime desc"
   objRst.Open 
   if objrst.EOF and objrst.BOF   then %>    
     <P> 
     <P align=center><font class="px12" color="black"><STRONG>没有您要的<%=km%>科目的报帐信息
   <%else%>
            ...
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               <tr bgColor="#ecf7fd" height="20">
                <td align="middle"  ><font class="px12" color="black">报帐时间</td>
                ...
                <%
                i=1
                do while not objrst.EOF and i<=45 %>
                <tr bgColor="#ecf7fd" height="20">
