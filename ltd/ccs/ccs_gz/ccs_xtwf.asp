...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <form method="post" action="ccs_xtwf_lu.asp" id=form1 name=form1>   
  ...
  <tbody>
   ...
   <tr>
    <td align="center"><font class="px12" color="black">您目前进入的是系统维护科目录入界面</td></tr>
    <tr>
    <td>
    &nbsp;
    </td>
    ...
    &nbsp;
     ...
     <td>
     <font class="px12" color="black">科目
     </td>
     <td>
    <input type="text" name="km" size="8">    
     </td>
     <td>
    <font class="px12" color="black"> 子科目
     </td>
      <td>
    <input type="text" name="zkm" size="8">    
     </td>
     <td>
    <font class="px12" color="black"> 显示顺序
     </td>
     <td>
    <input type="text" name="sx" size="8">    
     </td>
     </tr>
