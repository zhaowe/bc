...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    ...
    <td align="middle"><font class="px12" color="black">您目前进入的是深圳公司费用<font color="red"><font color="blue"><%="预提查询"%></font><%=cxsj%></font>页面</font></td></tr>
...
sql=sql+" and ifhandin='是' and cz<>'删除' and payway='预提' "
sql=sql+sql_bm
'变量
sql=sql+" ) as fy, "
sql=sql+" ( "
