...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    ...
    <td align="middle"><font class="px12" color="black">您目前进入的是公司费用<font color="red"><font color="blue"><%="托收查询"%></font><%=cxsj%></font>页面</font></td></tr>
    ...
    <table>
      ...
      <form action="ccs_gscxy_mxcx_tscx_lb.asp" method="post" id="form1" name="Form_Kmcode">
...
sql=sql+" and ifhandin='是' and cz<>'删除' and payway='托收' "
sql=sql+sql_bm
'变量
sql=sql+" ) as fy, "
sql=sql+" ( "
