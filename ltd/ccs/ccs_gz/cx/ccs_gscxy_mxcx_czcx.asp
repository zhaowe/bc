            ...
            <table border="0" cellspacing="0" cellpadding="3" name="menubutton">
              <tr>
                ...
                <td>&nbsp;</td>
                 ...
                 <td>&nbsp;</td>
                 <td>&nbsp;</td>
                 <td><a onmouseover="MM_swapimages('images4','','images/fycx.gif',1)" onmouseout="MM_swapImgRestore()" href="ccs_gscxy_mxcx.asp"><img height="20" src="images/flcx_cf.jpg" width="100" border="0" name="images4"></a></td>
              </tr>
            </table>
          </td>
        </tr>
