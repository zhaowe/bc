...
<div align="center">
  ...
  <center>
    ...
    SqlIns =SqlIns+"舱位=berthname,运价代码=pricecode,客票张数=count(price),金额=sum(price) "    
    SqlIns =SqlIns+" from "+ jdb
    SqlIns =SqlIns+" where "
    SqlIns =SqlIns+sqlwhere
    SqlIns =SqlIns+"  and (berthcode='Y150' or berthcode='Y130')  "
    SqlIns =SqlIns+" group by agentname,flightno,depcity,arrcity,berthname,pricecode "
    SqlIns =SqlIns+"order by agentname,depcity,arrcity,flightno,berthname,pricecode "
 ...
 <table border="0" cellspacing="1" width="96%" height="1" bgcolor="#0000FF" bordercolor="#0000FF">
    <tr>
      ...
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">运价代码</font></b></td>
