...
<% 
 ...
 if trim(session("UID"))<>"" then
  ...
  kmcode=Request.Form("kmcode")  
  fyzy=Request.Form("fyzy")  
            ...
            <table border="0" cellspacing="0" cellpadding="3" name="menubutton">
              <tr>
                ...
                <td>&nbsp;</td>
                 ...
                 <td>&nbsp;</td>
                 <td>&nbsp;</td>
                 <td><a onmouseover="MM_swapimages('images4','','images/fycx.gif',1)" onmouseout="MM_swapImgRestore()" href="ccs_gscxy_mxcx.asp"><img height="20" src="images/fycx_1.gif" width="100" border="0" name="images4"></a></td>
              </tr>
            </table>
          </td>
        </tr>
...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    ...
    <td align="middle"><font class="px12" color="black">您目前进入的是公司费用<font color="red"><font color="blue"><%="超支查询"%></font><%=cxsj%></font>页面</font></td></tr>
  ...
  <form action="ccs_gscxy_mxcx_czcx_lb.asp" method="post" id="form1" name="Form_Kmcode">
      ...
      <input id="text1" name="Kmcode" style="WIDTH: 70px; HEIGHT: 21px" size="16">      
...
if kmcode="" then 
  ...
  sql_km=" and fkmcode='" & kmcode &  "' "
end if

if seldepart="所有部门" then
  sql_bm=" "
else
  sql_bm=" and mnydepm='"& seldepart & "' "
end if   
...
'变量
sql=sql+" ) as yskm "
sql=sql+" where fy.mnykmcode=yskm.fkmcode "
    ...
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <tr>
          ...
          <A href="ccs_gscxy_mxcx_zycx_lb_dc.asp"><font class="px12" color=white>导出EXCEL文件</font></A> 
          </td>
        </tr>
        <tr>
          <td vAlign="top">
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               ...
               <tr bgColor="#7dadc4" height="20">
                ...
                <td align="middle"><font class="px12" color="black">报销单号</td>                
                <td align="middle"><font class="px12" color="black">科目代码</td>                                
                ...
                <td align="middle"><font class="px12" color="black"><%=objrst("tabid")%></td>
