...
function xx(s,y,x,z,a) { //v3.0
   //s=depar.value ;
   //y=nian.value ;
   surl="query1.asp?depar="+s+"&passcode="+y+"&bxcode="+x+"&date1="+z+"&date2="+a;
...
<form method="POST"  method="post" id="form1" name="form1"> 
     <table align="center" style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="30" cellSpacing="0" cellPadding="0" width="700" border="0">
   ...
   obj.Open
    ...
    %>	
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="action" value="查询" onclick="javascript:xx(depar.value,passcode.value,bxcode.value,date1.value,date2.value)">
     </td>
     </tr>             
    </table>
 </form>  
   ...
   sql="select * from cwys_infoin where ifhandin='是' and ifhx='是'"+sql1+sql2+sql3+sql4+"order by djdate desc"
   obj.Source=sql
   obj.Open
    %> 
   <% if not obj.eof then%>  
