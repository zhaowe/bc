...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    <td align="center"><font class="px12" color="black">您目前查询的是<font color="red"> <%=riqi%>年<%=session("dep")%><%=kem%>财务预算核定数</font></td></tr>
     <tr>
    <td align="right">&nbsp;</td></tr>  
    ...
    &nbsp;
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(1) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     ...
     %>
      ...
      <td>
  <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(2) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
   <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(3) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(4) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(5) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(6) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
    ...
    <tr>
     ...
     <td>
    <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(7) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(8) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(9) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     %>
      ...
      <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(10) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(11) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
     ...
     <td>
     <%objrst.Source ="select * from shenzhencwys_je where kem='"& kem &"' and yea='"& datet(12) &"' and dep='"& session("dep") &"'"
      objrst.Open%>
     <%if not objrst.BOF then%>
     <input type="text" name="m7" size="8" value=<%=objrst("mon")%>>    
     <%else%>
