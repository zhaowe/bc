...
<tr><td><font class="px12" color="red">已经提交财务,<%=mnyyear%>年度<%=jd%>季度允许额度<%=yxmy%>元，已经使用<%=mnyused+price%>,还能使用<%=shengyu-price%>元</font><input value="确 定" type="submit" name="action" onclick="javascript:reload()"></td></tr>
</table>
