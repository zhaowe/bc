...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <form method="post" action="km_copy1.asp" id="form1" name="form1">   
   ...
   <tr>
    <td align="center"><font class="px12" color="blue">您目前进入的是预算科目整年复制界面</td></tr>
   <tr>
    <td>
    &nbsp;
    </td>
    ...
    <tr>
    <td align="center"> 
    <font class="px14" color="black">将
    <select name="year1" style="HEIGHT: 22px; WIDTH: 57px"> 
    <option selected><%=year(date)%></option>
    <option><%=(year(date)-1)%></option>
    </select> 
    年的预算科目复制到 
     <select name="year2" style="HEIGHT: 22px; WIDTH: 57px"> 
     <option selected><%=(year(date)+1)%></option>
     <option><%=(year(date)+2)%></option></select> 年
     </font> 
    </td>
    </tr>
       <tr>
