...
%>
<%if edu-shengyu>0 then%>
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue><%=nian%>年<%=yue%>月的预算额度只剩余<%=shengyu%>元，小于你需要托收的<%=edu%>元金额。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
<%elseif jd1ky-jd1>0 and jd1sy<0 then%>
<table width=500>
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red>该次托收导致第一季度超标，未托收成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
<%elseif jd2ky-jd2>0 and jd2sy<0 then%>
<table width=500>
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red>该次托收导致第二季度超标，未托收成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
<%elseif jd3ky-jd3>0 and jd3sy<0 then%>
<table width=500>
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red>该次托收导致第三季度超标，未托收成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
<%elseif jd4ky-jd4>0 and jd4sy<0 then%>
<table width=500>
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red><%=jd4sy%>该次托收导致第四季度超标，未托收成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
...
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue>托收成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
