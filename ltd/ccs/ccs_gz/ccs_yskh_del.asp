...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <form method="post" action="ccs_yskh_delcl.asp" id=form1 name=form1>   
  ...
  <tbody>
   ...
   <tr>
    <td align="center"><font class="px12" color="black">您目前进入的是财务预算核定数<font color="red">删除界面</font></td></tr>
    <tr>
    <td>
    &nbsp;
    </td>
    </tr>
          <tr><td align="center"> <font class="px12" color="black">请选择要<font color="red">删除</font>的财务预算年份&nbsp;<select name="year1" style="HEIGHT: 22px; WIDTH: 57px"> <option selected><%=year(date)%></option>
    ...
    &nbsp;
       ...
       <tr><td align="center"> <font class="px12" color="black">请选择要<font color="red">删除</font>的财务预算项目&nbsp;<select name="kem" style="HEIGHT: 22px; WIDTH: 77px">
