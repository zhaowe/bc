...
<td> <font class=px12>年份：<%=obj("ys_year")%> <input type=hidden name=nian value=<%=obj("ys_year")%>></td>
<td> <font class=px12>部门：<%=obj("depar")%><input type=hidden name=depar value=<%=obj("depar")%>></td>
<td> <font class=px12>科目：<%=fkmshuom%><input type=hidden name=kemu value=<%=fkmshuom%>></td>
<td> <font class=px12>年度预算：<INPUT value="<%=obj("niandu")%>" type="text"  name=niandu size=15 onkeyup="javascript:display()" onchange="javascript:display()"></td>
</tr>

<tr height="25" bgcolor="#E3E9EE" align="left">
<td > <font class=px12>一月：<INPUT value="<%=obj("jan")%>" type="text"  name=jan size=10  onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>二月：<INPUT value="<%=obj("feb")%>" type="text"  name=feb size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>三月：<INPUT value="<%=obj("mar")%>" type="text"  name=mar size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>四月：<INPUT value="<%=obj("apr")%>" type="text"  name=apr size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
</tr>

<tr height="25" bgcolor="#E3E9EE" align="left">
<td > <font class=px12>五月：<INPUT value="<%=obj("may")%>" type="text"  name=may size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>六月：<INPUT value="<%=obj("jun")%>" type="text"  name=jun size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>七月：<INPUT value="<%=obj("jul")%>" type="text"  name=jul size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
<td > <font class=px12>八月：<INPUT value="<%=obj("aug")%>" type="text"  name=aug size=10 onkeyup="javascript:display()" onchange="javascript:display()"></td>
</tr>
