...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
   ...
   <% if not obj.eof then%>  
     ...
     <td ><font class="px12" color="black">一级科目代码</font></td>
     <td ><font class="px12" color="black">一级科目说明</font></td>
     <td ><font class="px12" color="black">二级科目代码</font></td>
     <td ><font class="px12" color="black">二级科目说明</font></td>
