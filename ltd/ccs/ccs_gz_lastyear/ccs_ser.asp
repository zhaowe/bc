...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    <td align="center" ><font color=black class=px12>您目前进入的是未核销<font color=red><%=km%></font>修改及删除界面</td></tr>
    <tr>
    <td align="right" >&nbsp;</td></tr>
   </tbody></table>
   <% objrst.Source = "select * from cwys_infoin  where  mnykm='" & km &"' and mnydepm='"&f&"' and ifhx='否' order by djdate desc"
   objRst.Open
   'Response.Write(objrst.source) 
   if objrst.EOF and objrst.BOF   then %>    
     <P> 
     <P align=center><font color=black class=px12><STRONG>没有你要的<%=km%>的信息
   <%else%>
            ...
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               <tr bgColor="#ecf7fd" height="20">
                <td align="middle"  ><font color=black class=px12>操作</td>
                <td align="middle"  ><font color=black class=px12>帐目时间</td>
              
                <td align="middle"  ><font color=black class=px12>子科目</td>
                <td align="middle"  ><font color=black class=px12>金额</td>
                <td align="middle"  ><font color=black class=px12>是否提交</td>
                <td align="middle"  ><font color=black class=px12>简要说明</td>
                <td align="middle"  ><font color=black class=px12>报销人</td>
                <td align="middle"  ><font color=black class=px12>录入人</td>
                <td align="middle"  ><font color=black class=px12>操作</td>
                </tr>
                <%
                ...
                <tr bgColor="#ecf7fd" height="20">
                <td align="middle"  ><a href="ccs_lu_xg.asp?q=<%=objrst("record_id")%>"><font color=blue class=px12>修改</font></a></td>
                <td align="middle" ><font color=black class=px12><%=year(objrst("mnytime"))%>年<%=month(objrst("mnytime"))%>月</td>
                
                <td align="middle" ><font color=black class=px12><%=objrst("mnykm")%></td>
                <td align="middle"  ><font color=black class=px12><%=objrst("price")%></td>
                <td align="middle"  ><font color=black class=px12><%=objrst("ifhandin")%></td>
                <td align="middle"  ><font color=black class=px12><%=objrst("mnynote")%></td>
                <td align="middle"  ><font color=black class=px12><%=objrst("bxname")%></td>
                <td align="middle"  ><font color=black class=px12><%=objrst("djname")%></td>
                <td align="middle"  ><a href="ccs_lu_del.asp?q=<%=objrst("record_id")%>&km=<%=objrst("mnykm")%>" onclick="return check()"><font color=red class=px12>删除</font></a></td>
                </tr>
                <%
                objrst.MoveNext 
                loop%> 
