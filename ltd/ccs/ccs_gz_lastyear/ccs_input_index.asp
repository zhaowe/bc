...
sql1="SELECT fkmshuom,fkmcode,kmshuom FROM cwys_km WHERE depar='"& f &"' and nian='"&year(date())-1&"' order by sn"                                                                            
...
<td><font class="px12">截止12月份费用总额</font></td>
