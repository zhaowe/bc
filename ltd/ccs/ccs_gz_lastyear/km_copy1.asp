...
<%
   ...
   sql="select * from cwys_km where nian='"& year1 &"'"
   obj.Source=sql
   obj.Open
   ...
   sql="select * from cwys_km where nian='"& year2 &"'"
   obj2.Source=sql
   obj2.Open
%>
<% if obj.EOF  then %> 
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue><%=year1%>年的预算科目数据不存在。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
<%elseif not obj2.EOF then%>
<%obj2.Close%>
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue><%=year2%>年的预算科目数据已经存在，请不要覆盖。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
<%else%>
...
descr="将"+year1+"年的所有科目复制给"+year2+"年。"
...
obj1.Source="select * from cwys_km"
obj1.Open 

Conn.BeginTrans                                                                          
obj1.AddNew
obj1("nian")=year2
obj1("kmcode")=obj("kmcode")
obj1("kmshuom")=obj("kmshuom")
obj1("fkmcode")=obj("fkmcode")
obj1("fkmshuom")=obj("fkmshuom")
obj1("depar")=obj("depar")
obj1("isover")=obj("isover")                                                                     
...
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue>复制成功！</font>
</td>
</tr>
<%end if%>
</table>
