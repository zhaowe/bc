...
<title><%=seldate1%>至<%=seldate2%>各代理人销售外公司客票情况</title>
<style type="text/css">
...
<body>
<p align="center"><b><font size="5" color="#000099"><%=seldate1%>至<%=seldate2%>各代理人销售<font color=red>外公司</font>客票情况</font></b></p>
<div align="center">
  <p align="left">  
  <center>
 ...
 <table border="0" cellspacing="1" width="96%" height="1" bgcolor="#0000FF" bordercolor="#0000FF">
    ...
    SqlIns ="exec cf_proc_temp1 '"& cstr(bdate) &"', '"& cstr(edate) &"'"
