...
<body>
<p align="center"><b><font size="5" color="#000099"><font color=red><%=agentname%></font>销售<font color=red><%=company%></font>所有客票明细表</b>(承运日期：<font color=red><%=bdate%></font>至<font color=red><%=edate%></font>)</font></p>
<div align="center">
  <p align="left">  
  <center>
    <%
    ...
    SqlIns =SqlIns+"票号=ticketno,舱位=berthname,运价代号=pricecode,折扣代号=berthcode,票价=price,奖励费率1=ar1,奖励费率2=ar2,奖励费率3=ar3,奖励费率4=ar4,奖励费率5=ar5,奖励费率6=ar6,暗扣=ankou,销售日期=saledate "
 ...
 <table border="0" cellspacing="1" width="96%" height="1" bgcolor="#0000FF" bordercolor="#0000FF">
    <tr>
      ...
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">奖励费率6</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">暗扣</font></b></td>    
