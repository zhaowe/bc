...
<h1 align="center"><b><font color="#9900cc" face="长城新魏碑体" class="px36">代理人销售财务报表系统(旧版)</font></b></h1>
  ...
  <div align="center" style="width: 650; height: 94">
    ...
    <form name="tijiao" method="post" action="RedirectRPT.asp">
      <table border="1" cellspacing="1" width="100%" bordercolor="#0099FF">
        <tr>
          ...
          <%if session("jycgbj")=false then %>
           <td ><input type="radio" value="7"name="R1"><font class="px12">代理人销售客票汇总(有奖励)</font></td>
          <%else%>
           <td ><input type="radio" value="7"name="R1"><font class="px12">代理人销售客票汇总(有奖励)</font></td>
           <td ><input type="radio" value="8"name="R1"><font class="px12">代理人销售客票汇总(有奖励)</font></td>
          <%end if%>
        </tr>
        <tr>
        ...
        <tr>
         ...
         <%
            ...
            sql="select distinct company from ticketinfo order by company"
           objrst.Source =sql
           objrst.Open 
         %> 
   ...
   objrst.Open 
         ...
         <%
            ...
            sql="select distinct depcity from ticketinfo order by depcity"
   objrst.Source =sql
   objrst.Open 
         %> 
         ...
         <%
            ...
            sql="select distinct arrcity from ticketinfo order by arrcity"
   objrst.Source =sql
   objrst.Open 
         %> 
