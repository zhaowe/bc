...
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue>截至<%=nian%>年<%=jd%>季度的预算额度剩余<%=shengyu%>元，小于你要预提的<%=edu%>元。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
...
<td align="center" width=500>
	<font class=px14 color=red>该次预提导致第一季度超标，未预提成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
...
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red>该次预提导致第二季度超标，未预提成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
...
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red>该次预提导致第三季度超标，未预提成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
...
<tr align="center" width=500>
<td align="center" width=500>
	<font class=px14 color=red><%=jd4sy%>该次预提导致第四季度超标，未预提成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
</table>
...
<tr align="center" >
<td align="center" >
	<font class=px14 color=blue>预提成功。</font></p>
	<input type="button" name="button" value="返回" onclick="JavaScript:history.go(-1)">
</td>
</tr>
