...
LoginID=session("LDLoginID")

'Response.Write LoginID'session("LDLoginID")
'Response.End
objRst.Source="select * from userinfo where loginid='" & LoginID & "'"
objRst.Open
Password=trim(objRst("password"))
objRst.Close
set objRst=nothing
