    ...
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <tr>
          ...
          <a href="ccs_bmgl_zttj.asp?syear=<%=syear%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="ccs_bmgl_zttj.asp?syear=<%=syear%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="ccs_bmgl_zttj.asp?syear=<%=syear%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="ccs_bmgl_zttj.asp?syear=<%=syear%>&month=jd4"><font class="px12" color=white>第四季度   </a></font><a href="ccs_bmgl_zttj.asp?syear=<%=syear%>&bm=<% =bm%>"><font class="px12" color=white>全年   </a></font></td></tr>
        <tr>
          <td vAlign="top">
