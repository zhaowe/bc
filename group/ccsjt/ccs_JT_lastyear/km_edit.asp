...
<tr height="20" bgcolor="#E3E9EE" align="left">
<td colspan=2> <font class=px12>一级科目代码：<INPUT value="<%=obj("kmcode")%>" type="text"  name=kmcode size=8></td>
</tr>

<tr height="20" bgcolor="#E3E9EE" align="left">
<td colspan=2> <font class=px12>一级科目说明：<INPUT value="<%=obj("kmshuom")%>" type="text"  name=kmshuom></td>
</tr>

<tr height="20" bgcolor="#E3E9EE" align="left">
<td colspan=2> <font class=px12>二级科目代码：<INPUT value="<%=obj("fkmcode")%>" type="text"  name=fkmcode></td>
</tr>

<tr height="20" bgcolor="#E3E9EE" align="left">
<td colspan=2> <font class=px12>二级科目说明：<INPUT value="<%=obj("fkmshuom")%>" type="text"  name=fkmshuom></td>
</tr>
<tr height="20" bgcolor="#E3E9EE" align="left">
