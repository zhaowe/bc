...
function xx(x,y,z) { 
   surl="yt_ch1.asp?depar="+x+"&kemu="+y+"&nian="+z;
...
<option value="" selected>请选择科目</option>
    ...
    <font class="px12" color="black"><input type="button"  value="查询" onclick="javascript:xx(depar.value,kemu.value,nian.value)"> </font>
 </td>
</tr>
