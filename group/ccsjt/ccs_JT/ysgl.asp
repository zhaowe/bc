...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
        ...
        <tr> 
          <td> 
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                     ...
                     <td><a href="ysgl.asp"><font class="px14" color="#FFFFFF">预算管理</font></a></td>
                     </tr>
           
                     <tr>
                     <td><img src="images/a.gif" WIDTH="28" HEIGHT="28"></td>
                     <td><a href="ys_init.asp"><font class="px14" color="#FFFFFF">预算初始化</font></a></td>
                     </tr>         
            </table>
          </td>
        </tr>
    ...
    <tr  bgcolor="#E3E9EE" height="30"  align="left">
   ...
   set obj.activeConnection=objConn
   if depar="全部" then
   sql="select * from cwys_ed where ys_year='"&nian&"' order by depar "
   else
   sql="select * from cwys_ed where depar='"&depar&"'  and ys_year='"&nian&"' "
   end if
   obj.Source=sql
   obj.Open
    %>
   <% if not obj.eof then%>  
     <table align="center" style="word-break:break-all;word-wrap:break-word;BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 0px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid"  cellSpacing="1" cellPadding="1" width="850" border="0">
     <tr  bgcolor="#E3E9EE" align="left">
     <td align=center ><font class="px12" color="blue">部门</font></td>
     <td align=center width="40"><font class="px12" color="black">年度</font></td>
     <td align=center ><font class="px12" color="black">科目名称</font></td>
     <td ><font class="px12" color="black">年度预算</font></td>
     <td ><font class="px12" color="black">一月</font></td>
     <td ><font class="px12" color="black">二月</font></td>
     <td ><font class="px12" color="black">三月</font></td>
     <td ><font class="px12" color="black">四月</font></td>
     <td ><font class="px12" color="black">五月</font></td>
     <td ><font class="px12" color="black">六月</font></td>
     <td ><font class="px12" color="black">七月</font></td>
     <td ><font class="px12" color="black">八月</font></td>
     <td ><font class="px12" color="black">九月</font></td>
     <td ><font class="px12" color="black">十月</font></td>
     <td ><font class="px12" color="black">十一月</font></td>
     <td ><font class="px12" color="black">十二月</font></td>
     <td align=center><font class="px12" color="blue">修改</font></td>
     </tr>   
   <%
   obj.MoveFirst 
   while not obj.EOF
   ...
   %>
     ...
     <td ><font class="px12" color="black"><%=obj("ys_year")%></font></td>
     <td ><font class="px12" color="black"><%=fkmshuom%></font></td>
     <td ><font class="px12" color="black"><%=obj("niandu")%></font></td>
     <td ><font class="px12" color="black"><%=obj("jan")%></font></td>
     <td ><font class="px12" color="black"><%=obj("feb")%></font></td>
     <td ><font class="px12" color="black"><%=obj("mar")%></font></td>
     <td ><font class="px12" color="black"><%=obj("apr")%></font></td>
     <td ><font class="px12" color="black"><%=obj("may")%></font></td>
     <td ><font class="px12" color="black"><%=obj("jun")%></font></td>
     <td ><font class="px12" color="black"><%=obj("jul")%></font></td>
     <td ><font class="px12" color="black"><%=obj("aug")%></font></td>
     <td ><font class="px12" color="black"><%=obj("sep")%></font></td>
     <td ><font class="px12" color="black"><%=obj("oct")%></font></td>
     <td ><font class="px12" color="black"><%=obj("nov")%></font></td>
     <td ><font class="px12" color="black"><%=obj("dece")%></font></td>
     <td ><input type="button" value="修改" onclick="javascript: edit(<%=obj("sn")%>,<%=nian%>)" id=button1 name=button1></td>
     </tr> 
   <%
   obj1.Close
   set obj1=nothing
