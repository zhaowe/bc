...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    <td align="center" ><font color=black class=px12>您目前进入的是考核科目修改及删除界面</td></tr>
    <tr>
    <td align="right" >&nbsp;</td></tr>
   </tbody></table>
   <% objrst.Source = "select * from shenzhencwys_khkem  where  dep='"& session("dep")&"'"
   objRst.Open 
            ...
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               ...
               <td align="middle"  ><font color=black class=px12>操作</td>
                ...
                <tr bgColor="#ecf7fd" height="20">
                <td align="middle"  ><a href="ccs_lu_xg.asp?q=<%=objrst("q")%>&km=<%=km%>"><font color=blue class=px12>修改</font></a></td>
                <td align="middle" ><font color=black class=px12><%=objrst("khkem")%></td>
                 <td align="middle"  ><a href="ccs_lu_del.asp?q=<%=objrst("q")%>&km=<%=km%>"><font color=red class=px12>删除</font></a></td>
                </tr>
                <%i=i+1
                objrst.MoveNext 
                loop%> 
