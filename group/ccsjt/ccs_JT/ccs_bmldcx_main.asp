...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
        ...
        <tr> 
          <td> 
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                  <%objrst.Source ="select distinct sx=fkmcode,kem=fkmshuom,depar from cwys_km where depar='"& bm &"' and nian='3000' order by sx" 
                  'objrst.Source ="select distinct kem,sx from shenzhencwys_dep where dep='"& session("dep") &"' order by sx" 
                   'Response.Write "select distinct sx=fkmcode,kem=fkmshuom,depar from cwys_km where depar='"& bm &"' and nian='"& syear &"' order by sx" 
                    ...
                    if objrst.EOF and objrst.BOF then
                     ...
                     <td width="116"><a href="ccs_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=objrst("kem")%>"><font class="px14" color="#FFFFFF"><%=objrst("kem")%></font></a></td>
                     </tr>
                     <%objrst.MoveNext %> 
                       <% wend 
                     end if  
    ...
    <td align=center><a href="ccs_bmldcx_main.asp?syear=<%=year(date)%>&bm=<% =bm%>"><font class="px14" color="#FFFFFF">各项统计</font></a></td>
  ...
  <tr>
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        <tbody>
        <tr>
          <td style="PADDING-LEFT: 10px; PADDING-TOP: 2px" bgColor="#4983a0" height="20"><font style="COLOR: #ffffff; FONT-FAMILY: Webdings">4</font><font color="#ffffff"><b></b></font> <font color=white><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=1"><font class="px12" color=white>1月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=2"><font class="px12" color=white>2月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=3"><font class="px12" color=white>3月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=4"><font class="px12" color=white>4月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=5"><font class="px12" color=white>5月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=6"><font class="px12" color=white>6月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=7"><font class="px12" color=white>7月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=8"><font class="px12" color=white>8月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=9"><font class="px12" color=white>9月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=10"><font class="px12" color=white>10月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=11"><font class="px12" color=white>11月</a> <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=12"><font class="px12" color=white>12月   </a>
          <a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd4"><font class="px12" color=white>第四季度   </a></font><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>"><font class="px12" color=white>全年   </a></font></td></tr>
        <tr>
          <td vAlign="top">
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               <tr bgColor="#7dadc4" height="20">
                ...
                <td align="middle" ><font class="px12" color="black"><a href="ccs_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=trim(objrst("fkmshuom"))%>&smonth=<%=lb%>"><%=objrst("fkmshuom")%></A></td>
   ...
   objrst.Open    
     %>        
                ...
                <td align="middle" ><font class="px12" color="blue"><a href="ccs_bmldcx_main.asp?syear=<%=syear%>&bm=<% =bm%>">所有科目</A></td>
