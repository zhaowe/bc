...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
        ...
        <tr> 
          ...
          <TR>
            ...
            <A onclick=javascript:ShowFLT(<%=j%>) 
                  href="javascript:void(null)"><font class="px14" color="#FFFFFF">+<%=trim(objrst_kmlb("kmshuom"))%></font></A> 
                  </TD>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                <TBODY>                 
                   ...
                   <%
                     ...
                     objrst.Source ="select distinct kmshuom,kmcode,fkmshuom,fkmcode from cwys_km where  kmshuom='"&trim(objrst_kmlb("kmshuom"))&"' order by kmcode,kmshuom,fkmcode,fkmshuom" 
                                        
                       objrst.Open 
                       while not objrst.EOF                   
                   %>
                  <TR>
                    <TD style="PADDING-LEFT: 0px" height=23>                     
                    <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=objrst("fkmshuom")%>">
                    <font class="px12" color=white>*<%=trim(objrst("fkmshuom"))%></font></A> 
                    </TD>
                  </TR>
    ...
    <td align=center><a href="ccs_gscxy_index.asp?syear=<%=year(date)%>"><font class="px14" color="#FFFFFF">各项统计</font></a></td>
...
<%' end if  %>        
   ...
   sql_bmkm="left join cwys_infoin b on a.fkmcode=b.mnykmcode and a.ys_year=b.mnyyear  and ifhandin='是' and cz<>'删除'  "  
   ...
   sql_bmkm="left join cwys_infoin b on a.fkmcode=b.mnykmcode and a.depar=b.mnydepm and a.ys_year=b.mnyyear  and ifhandin='是' and cz<>'删除'  "  
  ...
  <tr>
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
       ...
       <%' if km="所有科目" then  %>   
        <tr>
          <td style="PADDING-LEFT: 10px; PADDING-TOP: 2px" bgColor="#4983a0" height="20"><font style="COLOR: #ffffff; FONT-FAMILY: Webdings">4</font><font color="#ffffff"><b></b></font> <font color=white><a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=1"><font class="px12" color=white>1月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=2"><font class="px12" color=white>2月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=3"><font class="px12" color=white>3月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=4"><font class="px12" color=white>4月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=5"><font class="px12" color=white>5月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=6"><font class="px12" color=white>6月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=7"><font class="px12" color=white>7月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=8"><font class="px12" color=white>8月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=9"><font class="px12" color=white>9月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=10"><font class="px12" color=white>10月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=11"><font class="px12" color=white>11月</a> <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=12"><font class="px12" color=white>12月   </a>
          <a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>&month=jd4"><font class="px12" color=white>第四季度   </a></font><a href="ccs_gscxy_index.asp?syear=<%=syear%>&km=<%=km%>"><font class="px12" color=white>全年   </a></font>
            ...
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               <tr bgColor="#7dadc4" height="20">
                ...
                <% else  %>
                <td align="middle" ><font class="px12" color="black"><a href="ccs_gscxy_bmldcx_index.asp?syear=<%=syear%>&bm=<%=trim(objrst("depar"))%>&km=<%=trim(objrst("fkmshuom"))%>&month=<%=lb%>"><%=objrst("depar")%></A></td>
                <% end if  %>
   ...
   objrst.Open    
     %>        
                ...
                <td align="middle" ><font class="px12" color="blue"><a href="ccs_gscxy_index.asp?syear=<%=syear%>">所有科目</A></td>
...
<div id="Div5" style="Z-INDEX: 101; LEFT: 840px; POSITION: absolute; TOP:233px;display:none">
 <table width=86px border=0 cellpadding=0 cellspacing=0> 
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=1">一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=2">二月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=3">三月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=4">四月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=5">五月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=6">六月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=7">七月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=8">八月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=9">九月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=10">十月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=11">十一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=12">十二月预算报表</a></span></td></tr>
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=jd1">一季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=jd2">二季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=jd3">三季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>&month=jd4">四季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=gray style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"></span></td></tr>
    <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_index_excel.asp?syear=<%=syear%>&km=<%=km%>">全年预算报表</a></span></td></tr>
