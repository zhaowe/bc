...
<div align="center">
  ...
  <center>
    ...
    SqlIns ="select 代理人=agentname,起飞=depcity,到达=arrcity,航班号=flightno, "
    SqlIns =SqlIns+"客票张数=count(price),金额=sum(price), "
    SqlIns =SqlIns+"奖励费率1=ar1,奖励费率2=ar2,奖励费率3=ar3,奖励费率4=ar4,奖励费率5=ar5,奖励费率6=ar6,奖励费=sum(agentfee) "
    SqlIns =SqlIns+" from "+ jdb
    SqlIns =SqlIns+" where "
    SqlIns =SqlIns+sqlwhere
    SqlIns =SqlIns+"  and (ar1<>0 or ar2<>0 or ar3<>0 or ar4<>0 or ar5<>0 or ar6<>0) "
    SqlIns =SqlIns+" group by flightno,agentname,depcity,arrcity,ar1,ar2,ar3,ar4,ar5,ar6 "
    SqlIns =SqlIns+"order by agentname,depcity,arrcity,flightno,ar1,ar2,ar3,ar4,ar5,ar6 "
 ...
 <table border="0" cellspacing="1" width="96%" height="1" bgcolor="#0000FF" bordercolor="#0000FF">
    <tr>
      ...
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率1</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率2</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率3</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率4</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率5</font></b></td>
      <td  height="1" bgcolor="#99CCFF"><b><font color="#990099">促销费率6</font></b></td>
    </tr>
