...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tbody>
   ...
   <tr>
    ...
    <td align="middle"><font class="px12" color="black">您目前进入的是深圳公司费用<font color="red"><font color="blue"><%="摘要查询"%></font><%=cxsj%></font>页面</font></td></tr>
  ...
  <form action="ccs_gscxy_mxcx_zycx_lb.asp" method="post" id="form1" name="Form_Kmcode">
