...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
          ...
          <td> 
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                     ...
                     <td><a href="cwmain_cx.asp"><font class="px14" color="#FFFFFF">未核销查询</font></a></td>
                      ...
                      <tr>
                      <td><img src="images/a.gif" WIDTH="28" HEIGHT="28"></td>
                      <td><a href="query2_cncx.asp"><font class="px14" color="#FFFFFF">已删除查询</font></a></td>
                       </tr>
   ...
   obj.LockType=3
   obj.CursorType=3
   set obj.activeConnection=objConn1
   'if depar="全部" then
   sql="select * from cwys_log where operation='删除' and type='核销' order by operatetime desc"
   'else
   'sql="select * from cwys_log where depar='"&depar&"' and operation='删除' and type='核销' order by operatetime desc"
  ' end if
   obj.Source=sql
   obj.Open
    %> 
   <% if not obj.eof then%>  
     ...
     <td ><font class="px12" color="black">内容</font></td>
     <td style="line-height:200%"><font class="px12" color="black">删除时间</font></td>
   ...
   %>  
     ...
     <td ><font class="px12" color="black"><%=obj("descr")%></font></td>
     <td ><font class="px12" color="black"><%=obj("operatetime")%></font></td>
     </tr>  
   <%
   obj.movenext
   wend
