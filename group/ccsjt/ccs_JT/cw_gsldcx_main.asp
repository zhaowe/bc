...
function year1_onchange() {
  syear=year1.value ;
  surl='cw_gsldcx_main.asp?syear='+syear+'&month=';
...
function selkm_onchange() {
  ...
  //else   
     surl='cw_gsldcx_index.asp?syear='+syear+'&km='+sbm;
  window.document.location.href(surl);
}
...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
            ...
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                  <%
                    ...
                    if objrst.EOF and objrst.BOF then
                     ...
                     <td width="116"><a href="cw_bmldcx_main.asp?syear=<%=syear%>&bm=<%=objrst("depart")%>"><font class="px14" color="#FFFFFF"><%=objrst("depart")%></font></a></td>
                     </tr>
                     <%objrst.MoveNext %> 
                       <% wend 
                     end if  
    ...
    <td align=center><a href="cw_gsldcx_main.asp?syear=<%=syear%>"><font class="px14" color="#FFFFFF">各部门统计</font></a></td>
  ...
  <tr>
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        <tbody>
        <tr>
          <td style="PADDING-LEFT: 10px; PADDING-TOP: 2px" bgColor="#4983a0" height="20"><font style="COLOR: #ffffff; FONT-FAMILY: Webdings">4</font><font color="#ffffff"><b></b></font> <font color=white><a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=1"><font class="px12" color=white>1月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=2"><font class="px12" color=white>2月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=3"><font class="px12" color=white>3月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=4"><font class="px12" color=white>4月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=5"><font class="px12" color=white>5月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=6"><font class="px12" color=white>6月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=7"><font class="px12" color=white>7月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=8"><font class="px12" color=white>8月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=9"><font class="px12" color=white>9月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=10"><font class="px12" color=white>10月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=11"><font class="px12" color=white>11月</a> <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=12"><font class="px12" color=white>12月   </a>
          <a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=jd4"><font class="px12" color=white>第四季度   </a><a href="cw_gsldcx_main.asp?syear=<%=syear%>&month=全年"><font class="px12" color=white>全年   </a></font></td></tr>
        <tr>
          <td vAlign="top">
   ...
   objrst.Open    
     %>        
                ...
                <td align="middle" ><font class="px12" color="blue"><a href="cw_gsldcx_main.asp?syear=<%=syear%>">所有部门</A></td>
