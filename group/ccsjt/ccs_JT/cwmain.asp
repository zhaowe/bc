...
function xx(s,y,x,a,b,c,d) { //v3.0
   //s=depar.value ;
   //y=nian.value ;
   surl="cwmain.asp?depar="+s+"&passcode="+y+"&bxcode="+x+"&payway="+a+"&price="+b+"&tabid="+c+"&qijian="+d;
        ...
        <tr> 
          <td> 
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                     ...
                     <td><a href="cwmain.asp"><font class="px14" color="red">未核销查询</font></a></td>
                      </tr>
                      ...
                      <tr>
                      <td><img src="images/a.gif" WIDTH="28" HEIGHT="28"></td>
                      <td><a href="query2.asp"><font class="px14" color="#FFFFFF">已删除查询</font></a></td>
                       </tr>
