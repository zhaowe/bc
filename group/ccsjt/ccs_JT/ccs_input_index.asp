...
sqla="insert into cwys_infoin (passcode,passname,bxcode,bxname,djdate,djname,mnydepm,mnykm,mnynote,price,mnytime,payway,ifhandin,ifhx,mnyyear,mnykmcode,cz,tabid) values ('"&passcode&"','"&passname&"','"&bxcode&"','"&bxname&"','"&djdate&"','"&djname&"','"&mnydepm&"','"&trim(km)&"','"&mnynote&"',"&price&",'"&date1&"','"&payway&"','"&ifhandin&"','否','"&mnyyear&"','"&fkmcode1&"','录入','"&tabid&"')"                                                                            
'Response.Write(sqla)
...
<td><font class="px12">已经入库，已经提交</font></td>
</tr>
...
sqlb="insert into cwys_infoin (passcode,passname,bxcode,bxname,djdate,djname,mnydepm,mnykm,mnynote,price,mnytime,payway,ifhandin,ifhx,mnyyear,mnykmcode,cz,tabid) values ('"&passcode&"','"&passname&"','"&bxcode&"','"&bxname&"','"&djdate&"','"&djname&"','"&mnydepm&"','"&trim(km)&"','"&mnynote&"',"&price&",'"&date1&"','"&payway&"','"&ifhandin&"','否','"&mnyyear&"','"&fkmcode1&"','录入','"&tabid&"')"                                                                            
'Response.Write(sqlb)
...
<td><font class="px12" color="red">已经入库，没有提交!!!</font></td>
...
sqll="insert into cwys_infoin (passcode,passname,bxcode,bxname,djdate,djname,mnydepm,mnykm,mnynote,price,mnytime,payway,ifhandin,ifhx,mnyyear,mnykmcode,cz,isover,tabid) values ('"&passcode&"','"&passname&"','"&bxcode&"','"&bxname&"','"&djdate&"','"&djname&"','"&mnydepm&"','"&trim(km)&"','"&mnynote&"',"&price&",'"&date1&"','"&payway&"','"&ifhandin&"','否','"&mnyyear&"','"&fkmcode1&"','录入','是','"&tabid&"')"                                                                            
'Response.Write(sqla)
...
<td><font class="px12">已经入库，已经提交,此次提交由于财务允许超标</font></td>
</tr>
