...
function xx(s,y,x) { //v3.0
   //s=depar.value ;
   //y=nian.value ;
   surl="cwmain.asp?depar="+s+"&passcode="+y+"&bxcode="+x;
          ...
          <td width="605"> 
            <table border="0" cellspacing="0" cellpadding="3" name="menubutton">
              <tr>
                <td>&nbsp;</td>
                 <td>&nbsp;</td>
                <td><a href="cnmain.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapimages('images1','','images/baoxiao1.gif',1)"><img src="images/baoxiao.gif" width="120" height="24" border="0" name="images1"></a></td>
                <td><a href="ccs_gscxy_index.asp" target="_blank" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapimages('images4','','images/gltj2.jpg',1)"><img src="images/gltj1.jpg" width="120" height="24" border="0" name="images4"></a></td>
              </tr>
            </table>
          </td>
        </tr>
  ...
  <tr>
   ...
   obj.Open
    ...
    %>	
     ...
     &nbsp;&nbsp;<input type="button" name="action" value="查询" onclick="javascript:xx(depar.value,passcode.value,bxcode.value)">
     </td>
     </tr>             
    </table>
   ...
   set obj.activeConnection=objConn
   if depar="全部" then
   sql="select * from cwys_infoin where (passcode='"&passcode&"' or bxcode='"&bxcode&"') and ifhandin='是' and ifhx='否' order by djdate desc"
   else
   sql="select * from cwys_infoin where (mnydepm='"&depar&"' or passcode='"&passcode&"' or bxcode='"&bxcode&"') and ifhandin='是' and ifhx='否' order by djdate desc"
   end if
   obj.Source=sql
   obj.Open
    %> 
