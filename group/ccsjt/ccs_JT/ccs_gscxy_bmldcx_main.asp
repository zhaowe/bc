...
if trim(session("UID"))<>"" then
 dim objD
  set ObjD=server.CreateObject ("Com_UserManage1.ClsUserManage1")
       ...
       VerifyOk_gsfz=objD.VerifyUserFunction (session("UID"),"ccs_gsfzcx")
...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <td align=center><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=year(date)%>&bm=<% =bm%>"><font class="px14" color="#FFFFFF">各项统计</font></a></td>
  ...
  <tr>
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        <tbody>
        <tr>
          <td style="PADDING-LEFT: 10px; PADDING-TOP: 2px" bgColor="#4983a0" height="20"><font style="COLOR: #ffffff; FONT-FAMILY: Webdings">4</font><font color="#ffffff"><b></b></font> <font color=white><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=1"><font class="px12" color=white>1月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=2"><font class="px12" color=white>2月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=3"><font class="px12" color=white>3月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=4"><font class="px12" color=white>4月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=5"><font class="px12" color=white>5月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=6"><font class="px12" color=white>6月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=7"><font class="px12" color=white>7月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=8"><font class="px12" color=white>8月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=9"><font class="px12" color=white>9月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=10"><font class="px12" color=white>10月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=11"><font class="px12" color=white>11月</a> <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=12"><font class="px12" color=white>12月   </a>
          <a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd4"><font class="px12" color=white>第四季度   </a></font><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<%=bm%>"><font class="px12" color=white>全年   </a></font>
            ...
            <table cellSpacing="1" cellPadding="0" width="100%">
              <tbody>
               <tr bgColor="#7dadc4" height="20">
                ...
                <td align="middle" ><font class="px12" color="black"><a href="ccs_gscxy_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=trim(objrst("fkmshuom"))%>&smonth=<%=lb%>"><%=objrst("fkmshuom")%></A></td>
   ...
   objrst.Open    
     %>        
                ...
                <td align="middle" ><font class="px12" color="blue"><a href="ccs_gscxy_bmldcx_main.asp?syear=<%=syear%>&bm=<% =bm%>">所有科目</A></td>
...
<%end if%>    
 ...
 <table width=86px border=0 cellpadding=0 cellspacing=0> 
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=1">一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=2">二月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=3">三月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=4">四月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=5">五月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=6">六月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=7">七月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=8">八月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=9">九月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=10">十月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=11">十一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=12">十二月预算报表</a></span></td></tr>
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd1">一季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd2">二季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd3">三季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>&month=jd4">四季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=gray style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"></span></td></tr>
    <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_bmldcx_main_excel.asp?syear=<%=syear%>&bm=<%=bm%>">全年预算报表</a></span></td></tr>
