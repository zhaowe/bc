...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  %>
   ...
   <tr>
    <td align="center" ><font class="px12" color="black">您目前进入的是<font color=red><font color=blue><%="公司"%></font><%=cxsj%></font>各部门预算完成情况页面</td></tr>
    <tr>
    <td align="right" >&nbsp;</td></tr>
     <tr>
    <td align="right" >
    ...
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        ...
        <tr>
          ...
          <a href="ccs_gscxy_main.asp?syear=<%=syear%>&month=jd1"><font class="px12" color=white>   第一季度   </a><a href="ccs_gscxy_main.asp?syear=<%=syear%>&month=jd2"><font class="px12" color=white>第二季度   </a><a href="ccs_gscxy_main.asp?syear=<%=syear%>&month=jd3"><font class="px12" color=white>第三季度   </a><a href="ccs_gscxy_main.asp?syear=<%=syear%>&month=jd4"><font class="px12" color=white>第四季度   </a><a href="ccs_gscxy_main.asp?syear=<%=syear%>&month=全年"><font class="px12" color=white>全年   </a></font>
...
<div id="Div5" style="Z-INDEX: 101; LEFT: 840px; POSITION: absolute; TOP:233px;display:none">
 <table width=86px border=0 cellpadding=0 cellspacing=0> 
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=1">一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=2">二月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=3">三月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=4">四月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=5">五月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=6">六月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=7">七月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=8">八月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=9">九月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=10">十月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=11">十一月预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=12">十二月预算报表</a></span></td></tr>
  ...
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=jd1">一季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=jd2">二季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=jd3">三季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&month=jd4">四季度预算报表</a></span></td></tr>
  <tr><td valign="top" width="86px" bgcolor=gray style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"></span></td></tr>
    <tr><td valign="top" width="86px" bgcolor=#cccccc style="font-size:12px;font-family:宋体color：black;height:18px;filter:Alpha(opacity=100);border-left:1px solid #ffffff;border-right:1px solid #ffffff;" onmouseover="this.className='td_mouseover';" onmouseout="this.className='td_mouseout';"><span style="position:absolute"><a href="ccs_gscxy_main_excel.asp?syear=<%=syear%>&bm=<% =bm%>">全年预算报表</a></span></td></tr>
