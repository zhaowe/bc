...
<p align=center><font size=6 color=red>欢迎进入财务预算控制系统登陆页面</font></P>
            ...
            <table align="center" border="0" cellspacing="0" cellpadding="0" width=100%>
                 ...
                 <tr>
                     <td align="middle">&nbsp;&nbsp;&nbsp;
                        ...
                        <input type="reset" value="重置" name="Submit" style="WIDTH: 40px; HEIGHT: 25px">&nbsp;&nbsp;&nbsp;
                        <input type="button"  value="修改密码" name="chpwd" style="WIDTH: 60px; HEIGHT: 25px"  onclick="javascript:window.location.href='gz_changpwd.asp';">
                     </td>
                 </tr>
                 </form>
           </table>
