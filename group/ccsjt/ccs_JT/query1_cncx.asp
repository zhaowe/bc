...
function xx(s,y,x,z,a,b) { //v3.0
   //s=depar.value ;
   //y=nian.value ;
   surl="query1_cncx.asp?depar="+s+"&passcode="+y+"&bxcode="+x+"&date1="+z+"&date2="+a+"&tabid="+b;
   window.location.href (surl);
}
function del(sn)
{
tzurl="hx_del.asp?sn="+sn;
          ...
          <td width="605"> 
            <table border="0" cellspacing="0" cellpadding="3" name="menubutton">
              <tr>
                ...
                <td><a href="cx/ccs_gscxy_index.asp" target="_blank" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapimages('images4','','images/gltj2.jpg',1)"><img src="images/gltj1.jpg" width="120" height="24" border="0" name="images4"></a></td>           </tr>
            </table>
          </td>
        </tr>
      </table>
        ...
        <tr> 
          <td> 
            <table width="130" border="0" cellspacing="0" cellpadding="1">
                     ...
                     <td><a href="cwmain_cx.asp"><font class="px14" color="#FFFFFF">未核销查询</font></a></td>
                      </tr>
                      
                      <tr>
                      <td><img src="images/a.gif" WIDTH="28" HEIGHT="28"></td>
                      <td><a href="query1_cncx.asp"><font class="px14" color="red">已核销查询</font></a></td>
                       </tr>
...
<form method="POST"  method="post" id="form1" name="form1"> 
   ...
   obj.Open
    ...
    %>	
     ...
     核销时间：从<input name="date1" size="10" value="<%=date%>" readonly onClick="JavaScript:window.open('day.asp?form=form1&amp;field=date1&amp;oldDate='+this.value,'','directorys=no,location=no,toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,width=260,height=200,top=270,left=300');">
     至<input name="date2" size="10" value="<%=date%>" readonly onClick="JavaScript:window.open('day.asp?form=form1&amp;field=date2&amp;oldDate='+this.value,'','directorys=no,location=no,toolbar=no,status=no,menubar=no,scrollbars=no,resizable=no,width=260,height=200,top=270,left=300');">    
     
     <br>经办人员工号：<INPUT  type="text"  name="passcode" size=8>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    
     报销人员工号：<INPUT  type="text"  name="bxcode" size=8>&nbsp;&nbsp;&nbsp;报销单号：<INPUT  type="text"  name="tabid" size=12>
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="action" value="查询" onclick="javascript:xx(depar.value,passcode.value,bxcode.value,date1.value,date2.value,tabid.value)">
     </td>
     </tr>             
    </table>
 </form>  
      ...
      if date1<>"0:00:00" and date2<>"0:00:00"  then
      sql4="and hxdate>='"&date1&"' and hxdate<='"&date2&"'"
      end if      
   ...
   sql="select * from cwys_infoin where ifhandin='是' and ifhx='是'"+sql1+sql2+sql3+sql4+sql6+"order by djdate desc"
   obj.Source=sql
   obj.Open
    %> 
   <% if not obj.eof then%>  
     ...
     <td ><font class="px12" color="black">核销时间</font></td>
     <td ><font class="px12" color="black">核销人</font></td>
   ...
   %>  
     ...
     <td ><font class="px12" color="black"><%=obj("hxname")%></font></td>
