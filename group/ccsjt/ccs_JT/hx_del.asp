...
<tr height="20"  >
<td colspan=4 align="center"> <input value="确定" type="submit" name="action"> </td>
</tr>
...
<td align="center" width=500>
	<font class=px14 color=blue>删除成功。</font></p>
	<input type="button" name="button" value="确定" onclick="JavaScript:window.close();window.opener.document.location.reload()">
</td>
</tr>
</table>
<%
'Response.Write("<script>window.opener.document.location.reload();window.close()</script>") 
