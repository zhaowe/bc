...
function year1_onchange() {
  ...
  sbm='<%=bm%>' ;
  syear=year1.value ;
  surl='cw_bmldcx_index.asp?syear='+syear+'&bm='+sbm;
...
function selbm_onchange() {
  ...
  syear=year1.value ;
  if (sbm=="所有部门")
     surl='cw_gsldcx_main.asp?syear='+syear+'&bm='+sbm;
  else   
...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  ...
  <tr>
    ...
    <td align=center><a href="cw_bmldcx_main.asp?syear=<%=syear%>"><font class="px14" color="#FFFFFF">各项统计</font></a></td>
  ...
  <tr>
    <td vAlign="top" width="73%">
      <table style="BORDER-RIGHT: #4983a0 1px solid; BORDER-TOP: #4983a0 1px solid; BORDER-LEFT: #4983a0 1px solid; BORDER-BOTTOM: #4983a0 1px solid" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
        <tbody>
        <tr>
          <td style="PADDING-LEFT: 10px; PADDING-TOP: 2px" bgColor="#4983a0" height="20"><font style="COLOR: #ffffff; FONT-FAMILY: Webdings">4</font><font color="#ffffff"><b></b></font> <font color=white><a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=1"><font class="px12" color=white>1月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=2"><font class="px12" color=white>2月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=3"><font class="px12" color=white>3月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=4"><font class="px12" color=white>4月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=5"><font class="px12" color=white>5月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=6"><font class="px12" color=white>6月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=7"><font class="px12" color=white>7月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=8"><font class="px12" color=white>8月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=9"><font class="px12" color=white>9月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=10"><font class="px12" color=white>10月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=11"><font class="px12" color=white>11月</a> <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=12"><font class="px12" color=white>12月</a>
          <a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=jd1"><font class="px12" color=white>   第一季度   </a><a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=jd2"><font class="px12" color=white>第二季度   </a><a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=jd3"><font class="px12" color=white>第三季度   </a><a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=jd4"><font class="px12" color=white>第四季度   </a><a href="cw_bmldcx_index.asp?syear=<%=syear%>&bm=<%=bm%>&km=<%=km%>&smonth=全年"><font class="px12" color=white>全年   </a></font></td></tr>
        <tr>
