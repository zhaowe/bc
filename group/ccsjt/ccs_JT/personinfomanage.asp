...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <%sub list_data()%> 
    <form method="post" action="personinfomanage.asp?todo=02" id=form1 name=form1>   
...
<tr width=100%>
     <td  align="left">
     <font class="px12" color="black">&nbsp;&nbsp;员工号：</font>
     <input id="hbh" type="text" name="pid" size="10" ><font class="px12" color="black">  </font>  
    <font class="px12" color="black">&nbsp;&nbsp;姓名：</font>
     <input id="hbh" type="text" name="pname" size="10" ><font class="px12" color="black">  </font>
  ...
  set objRst.activeConnection=objConn
     ...
     objrst.Source = "select * from personinfo order by department,pid,pname"
   objRst.Open
          ...
          <td vAlign="top" width="564">
            <table cellSpacing="1" cellPadding="0" width="750">
              <tbody>
               ...
               <td align="middle" width="64"  ><font color=black class=px12>员工号</td>
                <td align="middle" width="64"  ><font color=black class=px12>姓名</td>
                ...
                <tr bgColor="#ecf7fd" height="20">
                 <td align="middle" width="64"  ><font color=black class=px12><%=objrst("department")%></td>
                  <td align="middle" width="64"  ><font color=black class=px12><%=objrst("pid")%></td>
                <td align="middle" width="64"  ><font color=black class=px12><%=objrst("pname")%></td>
          
               
                   
                <td align="middle" width="63"  ><a href="personinfomanage.asp?todo=01&sn=<%=trim(objrst("pid"))%>" onclick="return check()"><font color=red class=px12>删除</font></a></td>
...
sql="select count(*) as num from personinfo where pid='"&pid&"'"
...
if rs1("num")=0 then
  ...
  set rs1=server.CreateObject("adodb.recordset") 
 rs1.CursorLocation=2                                                                           
sqll="insert into personinfo (pid,pname,department) values ('"&pid&"','"&pname&"','"&depar&"')"                                                                            
'Response.Write(sqla)
rs1.Open sqll,conn_1,3,3,1

else
   Response.Write("<script   language=javascript>alert('您输入的用户已经存在，请查证，本次输入无效');</script>")
%>
...
sqll="delete personinfo where pid='"&sn&"'"                                                                            
'Response.Write(sqla)
