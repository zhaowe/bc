...
sql1="SELECT fkmshuom,kmshuom FROM cwys_km WHERE depar='"& f &"' and nian='"&year(date())&"' order by sn"                                                                            
...
'sqlk2="SELECT kmshuom FROM cwys_km WHERE depar='"& f &"' and nian='"&year(date())&"' and fkmcode='"&fkmcode1&"' order by sn"                                                                            
