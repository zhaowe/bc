...
<table width="740" border="0" cellspacing="0" cellpadding="0" height="90%">
  <tr>
    ...
    <form method="post" action="ccs_yskh_lu.asp" id=form1 name=form1>   
  ...
  <tbody>
   ...
   <tr>
    <td align="center"><font class="px12" color="black">您目前进入的是<font color="red">财务预算核定数</font>录入及修改界面</td></tr>
    <tr>
    <td>
    &nbsp;
    </td>
    </tr>
          <tr><td align="center"> <font class="px12" color="black">请选择财务预算年份&nbsp;<select name="year1" style="HEIGHT: 22px; WIDTH: 57px"> <option selected><%=year(date)%></option>
    <option>2007</option><option>2008</option><option>2009</option><option>2010</option></select>   <font color="#ff0000"></font>
      </td></tr>
       <tr>
    <td>
    &nbsp;
       ...
       <tr><td align="center"> <font class="px12" color="black">请选择财务预算项目&nbsp;<select name="kem" style="HEIGHT: 22px; WIDTH: 77px">
    ...
    &nbsp;
      ...
      <td>
    <input type="text" name="m1" size="8">    
     </td>
     <td>
     <input type="text" name="m2" size="8">    
     </td>
     <td>
     <input type="text" name="m3" size="8">    
     </td>
     <td>
     <input type="text" name="m4" size="8">    
     </td>
     <td>
     <input type="text" name="m5" size="8">    
     </td>
     <td>
     <input type="text" name="m6" size="8">    
     </td>
    ...
    <tr>
     ...
     <td>
    <input type="text" name="m7" size="8">    
     </td>
     <td>
     <input type="text" name="m8" size="8">    
     </td>
     <td>
     <input type="text" name="m9" size="8">    
     </td>
     <td>
     <input type="text" name="m10" size="8">    
     </td>
     <td>
     <input type="text" name="m11" size="8">    
     </td>
     <td>
     <input type="text" name="m12" size="8">    
     </td>
